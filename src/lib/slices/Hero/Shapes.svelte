...
<ContactShadows position={[0, -3.5, 0]} opacity={0.65} scale={40} blur={1} far={9}></ContactShadows>
<!-- Gem -->
<Geometry position={[0, 0, 0]} rate={0.3} geometry={new THREE.IcosahedronGeometry(3)}></Geometry>
<!-- Pill -->
<Geometry position={[1, -0.75, 4]} rate={0.4} geometry={new THREE.CapsuleGeometry(0.5, 1.6, 2, 16)}
></Geometry>
<!-- Soccer ball -->
<Geometry position={[-1.4, 2, -4]} rate={0.6} geometry={new THREE.DodecahedronGeometry(1.6)}
></Geometry>
<!-- Donut -->
<Geometry
	position={[-0.8, -0.75, 5]}
