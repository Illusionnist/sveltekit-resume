<script lang="ts">
	...
	onMount(() => {
		...
		window.onmousemove = (e) => {
			...
			let componentPercent = { x: (e.clientX - componentCenterX) / componentRect.width / 2 };

			let disFromCenterX = 1 - Math.abs(componentPercent.x);
...
<div class={clsx('relative h-full w-full', clasName)} bind:this={component}>
